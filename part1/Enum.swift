...
let balloonMessage = Message.balloon(userId: "2", date: Date())
let draftMessage = Message.draft(userId: "2", date: Date())
...
logMessage(message: draftMessage) // User 2 sends message: Bonjour!
logMessage(message: balloonMessage) // User 2 sends message: Bonjour!
